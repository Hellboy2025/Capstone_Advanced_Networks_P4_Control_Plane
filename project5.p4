...
const bit<8> ICMP_ECHO = 0x8;
const bit<8> ICMP_REPLY = 0x0;
/*************************************************************************
*********************** H E A D E R S  ***********************************
*************************************************************************/
...
parser MyParser(packet_in packet,
    ...
    state parse_ipv4 {
        ...
        transition select(hdr.ipv4.protocol) {
            TYPE_ICMP: parse_icmp; /* if ICMP packet, then parse ICMP */
            default: accept;
        }
    }
...
control MyIngress(inout headers hdr,
    ...
    action icmp_reply() {
        bit<32> original_srcAddr = hdr.ipv4.srcAddr;
        // Swap the source and destination addresses
        hdr.ipv4.srcAddr = hdr.ipv4.dstAddr;
        hdr.ipv4.dstAddr = original_srcAddr;
        // Set the ICMP type to ICMP_REPLY
